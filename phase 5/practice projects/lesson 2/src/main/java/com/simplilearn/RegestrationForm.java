...
public class RegestrationForm {
	...
	public void invokeBrowser() {
		 ...
		 WebDriver driver = new ChromeDriver();
		  ...
		  driver.findElement(By.xpath("//*[@id='email_create']")).sendKeys("karersneha@gmail.com");
		  ...
		  driver.findElement(By.xpath("//*[@id='customer_firstname']")).sendKeys("Sneha");
		  driver.findElement(By.xpath("//*[@id='customer_lastname']")).sendKeys("Karer");
